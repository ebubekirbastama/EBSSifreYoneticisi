...
namespace EBSSifreYoneticisi
{
    internal class Ebssfryntcs
    {
        ...
        public static string processChroume = "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe";
        ...
        public static void ProcessStart(string folder,string url)
        {
            ProcessStartInfo startInfo = new ProcessStartInfo(folder);
